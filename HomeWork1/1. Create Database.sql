...
/*Связываю таблицы*/
ALTER TABLE Product
ADD CONSTRAINT FK_TypeProducts_TypeProductId FOREIGN KEY(TypeProductId) REFERENCES Product(Id);
GO
...
VALUES ('Баклажан', 1, 'Серо-зеленый', 28),
	   ('Лук репчатый', 1, 'Зеленый', 43),
	   ('Морковь', 1, 'Оранжевый', 43),
	   ('Бананы', 2, 'Желтый', 90),
	   ('Смородина', 2, 'Черный', 43),
	   ('Вишня', 2, 'Темно-красная', 25);
GO

/*Запрос*/
CREATE VIEW up_sel_ShowInfoProduct
AS
